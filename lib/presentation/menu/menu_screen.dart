...
class _MenuScreenState extends State<MenuScreen> with TickerProviderStateMixin {
  ...
  AssetImage assetImage = new AssetImage('assets/purple_texture.jpg');
  ...
  void initState() {
    ...
    assetImage.resolve(new ImageConfiguration()).addListener((imageInfo, __) {
      if (mounted) {
        setState(() {
  ...
  createMenuItems(MenuController menuController, BuildContext context) {
    ...
    for (var i = 0; i < widget.menu.items.length; ++i) {
      ...
      final isSelected = widget.menu.items[i].page == widget.selectedPage;
      ...
      listItems.add(new AnimatedMenuListItem(
        ...
        menuListItem: new _MenuListItem(
          title: widget.menu.items[i].title(context),
          isSelected: isSelected,
          onTap: () {
            widget.onMenuItemSelected(widget.menu.items[i].page);
    ...
    return new ZoomScaffoldMenuController(
      ...
      return new Container(
        ...
        decoration: new BoxDecoration(
          color: backgroundImage == null ? Colors.black : null,
        ...
        child: new Material(
          ...
          child: new Stack(
            children: [
              createMenuItems(menuController, context),
